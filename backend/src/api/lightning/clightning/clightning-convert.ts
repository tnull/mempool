...
export enum FeatureBits {
	...
	ProvideStorageRequired = 42,
	ProvideStorageOptional = 43,
...
export const FeaturesMap = new Map<FeatureBits, string>([
	...
	[FeatureBits.OnionMessagesRequired, 'onion-messages'],
	[FeatureBits.OnionMessagesOptional, 'onion-messages'],
	[FeatureBits.ProvideStorageRequired, 'provide-storage'],
	[FeatureBits.ProvideStorageOptional, 'provide-storage'],
	...
	[FeatureBits.SpliceRequired, 'splice'],
	[FeatureBits.SpliceOptional, 'splice'],
